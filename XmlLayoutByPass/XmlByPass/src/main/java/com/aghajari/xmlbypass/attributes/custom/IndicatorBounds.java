...
/**
 * Parser of IndicatorBounds attributes
 * <code>android:indicatorLeft</code>,
 * <code>android:indicatorRight</code>,
 * <code>android:indicatorStart</code>,
 * <code>android:indicatorEnd</code>
 */
public class IndicatorBounds implements AttributesParser {
    ...
    public String[] parse(HashMap<String, String> map) {
        ...
        if (relative) {
            return new String[]{"setIndicatorBoundsRelative(" + start + ", " + end + ")"};
        } else {
            return new String[]{"setIndicatorBounds(" + left + ", " + right + ")"};
        }
    }
