...
/**
 * <code>android:drawableTint</code> parser
 */
public class CompoundDrawableTint implements AttributesParser {
    private final static String KEY = "android:drawableTint";
    ...
    public String[] parse(HashMap<String, String> map) {
        ...
        return new String[]{"setCompoundDrawableTintList(android.content.res.ColorStateList.valueOf(" +
