...
public class AttrFactory {
    ...
    public static Attr[] attrs = new Attr[]{
            ...
            new Attr("nextFocusLeft", "reference_id"),
            new Attr("nextFocusRight", "reference_id"),
            new Attr("nextFocusUp", "reference_id"),
            new Attr("nextFocusDown", "reference_id"),
            new Attr("nextFocusForward", "reference_id"),
    ...
    public static Attr[] textAttrs = {
            ...
            new Attr("textColorHint", "color"),
            new Attr("textColorLink", "color"),
